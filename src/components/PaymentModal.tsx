      ...
      <div className="overflow-y-auto max-h-[85vh] sm:max-h-[90vh] relative z-[1]">
        ...
        <div className="relative px-6 pt-6 pb-6 text-center">
          ...
          <div className="relative w-20 h-20 mx-auto mb-5 mt-4 flex items-center justify-center">
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[180%] h-24 rounded-full bg-[hsl(var(--violet-super-light)/0.10)] blur-[90px] pointer-events-none" /> pointer-events-none" />
