        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <div className="flex items-center bg-muted border border-border rounded-[10px] gap-3 cursor-pointer hover:brightness-95 transition-all" style={{ height: 48, padding: "6px 16px" }}>
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-full bg-[#AC76FF] flex items-center justify-center text-[16px] font-medium text-white">A</div>
              <span className="text-[14px] font-normal text-foreground">212,384</span>
            </div>
            <div className="w-px h-4 bg-border" />
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-full bg-[#FF7D60] flex items-center justify-center text-[16px] font-medium text-white">S</div>
