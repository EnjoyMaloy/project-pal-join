    ...
    >
      <div className="max-w-full mx-auto px-9 flex items-center justify-between h-full gap-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <div className="flex items-center bg-background border border-border rounded-[10px] gap-3 cursor-pointer hover:brightness-95 transition-all" style={{ height: 48, padding: "6px 16px" }}>
