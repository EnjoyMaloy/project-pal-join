...
const SubscriptionModal = ({ open, onOpenChange }: SubscriptionModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[440px] max-h-[90vh] p-0 gap-0 border-0 rounded-3xl shadow-2xl overflow-hidden [&>button.absolute]:hidden bg-gradient-to-b from-[hsl(280_92%_3%)] to-[hsl(280_92%_12%)]">
