...
const InstructionCard = ({ card }: { card: CardData }) => {
  ...
  return (
    <Wrapper {...wrapperProps} className="flex flex-col w-[280px] min-w-[280px] group cursor-pointer rounded-xl overflow-hidden transition-transform duration-200 hover:-translate-y-1" style={{ background: card.gradient, border: `2px solid ${card.borderColor}25` }}>
