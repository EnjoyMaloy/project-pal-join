...
const STATIC_CARDS: CardData[] = [
  {
    ...
    borderColor: "#BF96FF",
    views: 3104,
    gradient: "linear-gradient(180deg, #BF96FF 0%, #7B5EA7 100%)",
    image: img3dSecurity,
    isDbArticle: false,
  },
  {
    ...
    borderColor: "#FFCC47",
    views: 956,
    gradient: "linear-gradient(180deg, #FFE066 0%, #FFA726 100%)",
    image: img3dNft,
    isDbArticle: false,
  },
  {
    ...
    borderColor: "#FF8A80",
    views: 1842,
    gradient: "linear-gradient(180deg, #FFB3C1 0%, #FF6F91 100%)",
    image: img3dCoin,
    isDbArticle: false,
  },
  {
    ...
    borderColor: "#A0D468",
    views: 2738,
    gradient: "linear-gradient(180deg, #D4FC79 0%, #96E6A1 100%)",
    image: img3dRocket,
    isDbArticle: false,
  },
];
