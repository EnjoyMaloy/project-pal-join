              ...
              <div className="hidden md:flex items-center gap-2">
                {(["ai", "crypto"] as Category[]).map((cat) => {
                  ...
                  return (
                     <button
                      ...
                      className={`px-5 py-2 rounded-lg text-[15px] font-medium transition-colors ${isActive ? 'bg-primary text-primary-foreground' : 'bg-muted dark:bg-transparent dark:border dark:border-white/40 text-muted-foreground hover:text-foreground'}`}
                    >
                      {label}
                    </button>
                  );
                ...
                {activeCategory !== "all" && (
                  <button
                    ...
                    className="px-5 py-2 rounded-lg text-[15px] bg-muted dark:bg-transparent dark:border dark:border-white/40 text-muted-foreground hover:text-foreground transition-colors"
                  >
