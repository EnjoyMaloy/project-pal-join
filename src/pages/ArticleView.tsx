...
const STATIC_ARTICLES: Record<string, StaticArticle> = {
  "static-1": {
    ...
    content: `
      ...
      <p class="text-2xl">Перед тем как взаимодействовать с контрактом, убедитесь, что он прошёл аудит. Используйте инструменты вроде Etherscan для проверки верифицированного кода контракта.</p>
      <h3>3. Безопасное хранение ключей</h3>
      <p class="text-xl">Используйте аппаратные кошельки для хранения значительных сумм. Никогда не храните приватные ключи в текстовых файлах или облачных хранилищах.</p>
      <h3>Рекомендации</h3>
      <ul>
