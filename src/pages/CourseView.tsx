        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 mb-4 flex-wrap">
              ...
              {course.price !== null && (
                <span className="inline-flex items-center justify-center gap-[3px] rounded-full border border-[rgba(146,76,254,0.1)] px-3 py-1 text-[13px] font-medium text-violet-super-dark dark:text-[#E8DCFB] dark:border-[rgba(232,220,251,0.2)] dark:bg-[rgba(146,76,254,0.25)]"
